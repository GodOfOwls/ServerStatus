...
try:
    ...
    example: dict = {
        "server": "bolverblitz.net",
        "user": "depp",
        "password": 'dödel'
    }
    config_file = open('example.config.json', 'w+')
    json.dump(example, config_file)
    print('Please fill out the Config before i come to your House and stab you. Thanks :D 🦉')
    sys.exit()
